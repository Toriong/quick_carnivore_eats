...
export const ModalConditionalsDisplayAndInfoContext = createContext()

// the conditionals for opening a modal and what will be displayed on the modal
export const ModalConditionalsDisplayAndInfoProvider = (props) => {
    ...
    // the meat item info from the search bar will be stored in this state value directly below
    ...
    return <ModalConditionalsDisplayAndInfoContext.Provider value={{
        ...
        {props.children}
    </ModalConditionalsDisplayAndInfoContext.Provider>
};
